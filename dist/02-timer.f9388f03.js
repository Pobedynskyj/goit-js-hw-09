            ...
            refs.btnStart.addEventListener("click", ()=>{
                timerId = setInterval(()=>{
                    ...
                    if (delta < 1000) {
                        ...
                        (0, _notiflix.Notify).success("Timeout");
                    }
                }, DELAY);
            });
        } else {
            refs.btnStart.setAttribute("disabled", true);
            (0, _notiflix.Notify).failure("Please choose a date in the future");
        }
    }
};
...
(0, _flatpickrDefault.default)(`input[type="text"]`, options);
...
},{}],"eVN6V":[function() {},{}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
